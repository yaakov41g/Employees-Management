...
In case you didn't get the confirmation link in your email , expend EmailConfirmationLink folder in Solution Explorer panel ,open nlog file there pres control+leftbuttonclick the limk there.
     ...
     In order to interact correctly with the application, you should register , and do this by your own real email address. 
...
כנראה בגלל בעיה בדפנסיס/פקאג'ס שסומנו בסימן קריאה (בחלון הסולושן)י
כעת רצה תקין
